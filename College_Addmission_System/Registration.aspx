<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/HomePage.Master" CodeBehind="Registration.aspx.cs" Inherits="College_Addmission_System.Registration" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        style="color: #FFFFFF; background-color: #808080; font-size: 20px; font-weight: bold; height: 515px; margin-left: 0px; width: 100%;">
            ...
            <tr>
                <td class="style20">
                    <span class="style19"><uc1:date ID="date1" runat="server" />
                    <br />
                    <br />
                    </span>
                </td>
